...
class DesignEditor extends DressElement {
    ...
    onCreated() {
        ...
        this._callback = {
            Lock: this._onLockElement.bind(this),
            Unlock: this._onUnlockElement.bind(this),
            ElementSelected: this._onSelectedElement.bind(this),
            ElementDeselected: this._onDeselectedElement.bind(this),
            EditorConfigChanged: this._onChangedEditConfig.bind(this),
            ChangeStyle: this._onStyleChanged.bind(this),
            ChangeAttribute: this._onAttributeChanged.bind(this),
            RemoveAttribute: this._onAttributeRemoved.bind(this),
            ChangeContent: this._onContentChanged.bind(this),
            ElementInserted: this._onElementInserted.bind(this),
            ElementDeleted: this._onElementDeleted.bind(this),
            ElementMoved: this._onElementMoved.bind(this),
            ScriptInserted: this._onScriptInserted.bind(this),
            StyleInserted: this._onStyleInserted.bind(this),
            Show: this._onShowElement.bind(this),
            Hide: this._onHideElement.bind(this),
            ChangeProfile: this._onChangeProfile.bind(this),
            ChangeShape: this._onChangeShape.bind(this),
            SaveFile: this._onSaveFile.bind(this)
        };

        eventEmitter.on(EVENTS.Lock, this._callback.Lock);
        eventEmitter.on(EVENTS.Unlock, this._callback.Unlock);
        eventEmitter.on(EVENTS.ElementSelected, this._callback.ElementSelected);
        eventEmitter.on(EVENTS.ElementDeselected, this._callback.ElementDeselected);
        eventEmitter.on(EVENTS.EditorConfigChanged, this._callback.EditorConfigChanged);
        eventEmitter.on(EVENTS.ChangeStyle, this._callback.ChangeStyle);
        eventEmitter.on(EVENTS.ChangeAttribute, this._callback.ChangeAttribute);
        eventEmitter.on(EVENTS.RemoveAttribute, this._callback.RemoveAttribute);
        eventEmitter.on(EVENTS.ChangeContent, this._callback.ChangeContent);
        eventEmitter.on(EVENTS.ElementInserted, this._callback.ElementInserted);
        eventEmitter.on(EVENTS.ElementDeleted, this._callback.ElementDeleted);
        eventEmitter.on(EVENTS.ElementMoved, this._callback.ElementMoved);
        eventEmitter.on(EVENTS.ScriptInserted, this._callback.ScriptInserted);
        eventEmitter.on(EVENTS.StyleInserted, this._callback.StyleInserted);
        eventEmitter.on(EVENTS.Show, this._callback.Show);
        eventEmitter.on(EVENTS.Hide, this._callback.Hide);
        eventEmitter.on(EVENTS.ChangeProfile, this._callback.ChangeProfile);
        eventEmitter.on(EVENTS.ChangeShape, this._callback.ChangeShape);
        eventEmitter.on(EVENTS.DocumentSave, this._callback.SaveFile);
