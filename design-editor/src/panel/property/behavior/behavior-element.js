...
const OPTION_PLACEHOLDER = 'Choose File...',
	BEHAVIOURS_TEMPLATE_PATH = '/panel/property/behavior/behavior-element.html',
	BEHAVIOUR_ITEM_TEMPLATE_PATH = '/panel/property/behavior/behavior-item.html';

/**
 * Responsible for behaviours panel
 * @class Behavior
 */
class Behavior extends DressElement {
	...
	onCreated() {
		...
		this.createFromTemplate(BEHAVIOURS_TEMPLATE_PATH, {
			callback: () => {
