...
const plugins = [
    new CopyWebpackPlugin([
        {from: path.resolve(CONTEXT, 'vsc'), to: path.resolve(OUTPUT, 'design-editor/vsc')},
...
const alias = {
    'fs': path.resolve(CONTEXT, 'vsc-extension/design-editor/libs/fs.js'),
    labels: path.resolve(CONTEXT, 'vsc-extension/design-editor/labels.js'),
    'fs-extra': path.resolve(CONTEXT, 'vsc-extension/design-editor/libs/fs-extra.js'),
    atom: path.resolve(CONTEXT, 'vsc-extension/design-editor/libs/atom.js'),
    brackets: path.resolve(CONTEXT, 'vsc-extension/design-editor/libs/brackets.js'),
    ...
    'html-assistant-editor':  path.resolve(CONTEXT, 'vsc-extension/design-editor/libs/html-assistant-editor.js') 
};
