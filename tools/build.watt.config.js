...
const plugins = [
	new CopyWebpackPlugin([
		...
		},
		{
			...
			to: path.resolve(OUTPUT, 'design-editor/node_modules/closet-default-component-packages')
		},
		{
		...
		},
		{
			...
			to: path.resolve(OUTPUT, 'design-editor/node_modules/closet-component-packages')
		},
		{
			from: path.resolve(CONTEXT, 'tau-component-packages'),
			to: path.resolve(OUTPUT, 'design-editor/node_modules/tau-component-packages')
		},
		{
			from: path.resolve(CONTEXT, 'content-manager'),
			to: path.resolve(OUTPUT, 'design-editor/node_modules/content-manager')
		},
		{
